  ...
  <Header/>
    <div className="px-[30px] md:px-[80px] lg:px-[130px] py-[75px] bg-[#990019] text-white  ">
      <h3 className="mb-5 text-xl font-bold">
        ...
        abouSt sickle cell. And this is just the beginning—expect to see more
      ...
      <p className="mb-5">
        We collect this information to help tailor the content that is delivered
        to you and improve our programs.
      </p>
